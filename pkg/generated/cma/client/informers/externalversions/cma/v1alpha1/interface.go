...
type Interface interface {
	// SDSAppBundles returns a SDSAppBundleInformer.
	SDSAppBundles() SDSAppBundleInformer
...
// SDSAppBundles returns a SDSAppBundleInformer.
func (v *version) SDSAppBundles() SDSAppBundleInformer {
	return &sDSAppBundleInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
